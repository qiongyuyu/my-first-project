...
exports.networkListener = exports.NetworkListener = exports.offlineCache = void 0;
class OfflineCache {
    constructor() {
        this.queueKey = 'offlineQueue';
...
// 导出单例
exports.offlineCache = OfflineCache.getInstance();
/**
 * 网络状态监听器
 */
...
// 全局网络监听器实例
exports.networkListener = new NetworkListener();
